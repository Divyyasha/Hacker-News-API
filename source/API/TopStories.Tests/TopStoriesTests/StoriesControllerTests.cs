...
namespace TopStories.Tests
{
    public class StoryControllerTests
    {
        ...
        public async Task GetStories_ShouldReturnOkResult_WhenStoriesAreFound()
        {
            ...
            var controller = new StoriesController(_storyServiceMock.Object);

            // Act
            var result = await controller.GetStories(page: 1, pageSize: 10);
        ...
        public async Task GetStories_ShouldReturnFilteredStories_WhenSearchTitleIsProvided()
        {
            ...
            // Act
            var result = await controller.GetStories(page: 1, pageSize: 10, searchTitle: searchTitle);
